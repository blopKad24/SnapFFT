...
def run_matlab_filter(engine, hsv_frame, filter_mode, filter_radius, dc_protect_radius, intensity):
    ...
    matlab_frame = matlab.uint8(v_channel.tolist())                                                 #Convert numpy array -> matlab-compatible. matlab.uint8 needs a list of rows.
                                                                                                    ...
                                                                                                    #Call fft_filter5.m nargout=1 here because this will return in total 1 output
...
def main():
    ...
    matlab_engine.addpath(r'C:\Users\kadam\Desktop\SnapFFT\final', nargout=0)  #tells matlab where fft_filter5.m is kept. nargout=0 means this function wont return anything; so dont stall
